function[U2Correct, Lambda2Correct] = fullNewtonAugmentedResidual(iU2Guess, iLambda2Guess, S2, iU0, iLambda0, S0, tolerance, gridSize)
    h = 1 / (gridSize - 1);
    h2Inv = 1 / (h * h);
    ...
    while error > tolerance
        ...
        DeltaULambdaVec = Jhat \ REtaKVector;
